 ...
 <div className="rounded-3xl p-8 max-w-4xl mx-auto text-slate-200 shadow-lg select-none h-[80vh] sm:auto">
  ...
  <div className="grid md:grid-cols-1 gap-10">
    ...
    <div className="flex flex-col items-center text-center space-y-2">
      <img
        src="https://raw.githubusercontent.com/atmbr/codemc/main/src/assets/imagem/help/input-cmd-1.png"
    ...
    <div className="flex flex-col items-center text-center space-y-2">
      <img
        src="https://raw.githubusercontent.com/atmbr/codemc/main/src/assets/imagem/help/sugg-cmd-1.png"
